...
namespace Juskora\Bundle\Example3rdPartyExtensiontest2\DependencyInjection;
...
final class JuskoraExample3rdPartyExtensiontest2Extension extends Extension implements PrependExtensionInterface
{
    /**
    ...
    private function prependJMSTranslation(ContainerBuilder $container): void
    {
        $container->prependExtensionConfig('jms_translation', [
            'configs' => [
                'juskora_example3rdpartyextensiontest2' => [
                    'dirs' => [
                        __DIR__ . '/../../',
                    ],
                    'excluded_dirs' => ['Behat'],
